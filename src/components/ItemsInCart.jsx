...
export function ItemsInCart({image,name,quantity,price,id}){
    ...
    <div>
        ...
        <div><button onClick={() => removeItem(id)} className="p-1 bg-gray-500"><FontAwesomeIcon icon={faMinus} /></button><span className='p-1 text-primary'>{quantity}</span><button onClick={() => addItem(id)} className="p-1 bg-gray-500"><FontAwesomeIcon icon={faPlus} /></button></div>
    </div>
