...
export function Cart(){
    ...
    <div className="h-[85%] w-[85%] bg-[hsl(18.12_99.02%_60%)] shadow-[0px_10px_30px_5px_hsl(214.29_17.41%_40%)] rounded-lg p-10">
        ...
        <p className='p-3 font-poppins tracking-tight font-bold'>Your shopping list</p>
        <div className="flex gap-5">
            ...
            <div className="flex-[1] p-4 shadow-xl block rounded text-black">
                ...
                <button className='p-2 px-10 bg-black font-bold text-primary rounded  mt-4 shadow-xl active:scale-95'>Proceed to Buy</button>
                </div>
            </div>
        </div>
    </div>
