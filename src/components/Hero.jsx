...
export function Hero(){
    return <div>
        ...
        <Link to='/wishlist'><button className='p-2 px-10 bg-[hsl(18.12_99.02%_60%)] font-bold text-primary rounded opacity-85 hover:opacity-100 mt-4 shadow-xl active:scale-95'>Shop now</button></Link>
